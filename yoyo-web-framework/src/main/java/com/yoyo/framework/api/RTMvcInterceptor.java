 ...
 ***/
@Slf4j
public class RTMvcInterceptor implements HandlerInterceptor {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler) throws Exception {
        RTMvcContext context = new RTMvcContext()
                ...
                .setClientReqTime(LocalDateTime.now().toInstant(SystemConstant.SYSTEM_ZO).toEpochMilli())
                .setTraceId(Optional.ofNullable(MDC.get(SystemConstant.SYSTEM_TRACE_ID)).orElse(SystemConstant.SYSTEM_EMPTY))
    ...
    public void postHandle(HttpServletRequest request, HttpServletResponse response, Object handler, ModelAndView modelAndView) throws Exception {
        log.info("{} postHandle", "[RTMvcInterceptor]");
    }
