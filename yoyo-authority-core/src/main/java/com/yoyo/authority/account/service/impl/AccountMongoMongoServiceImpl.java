 ...
 ***/
@Service
public class AccountMongoMongoServiceImpl extends RTMongoMongoServiceCacheImpl<String, AccountDTO> implements IAccountService  {

    public AccountMongoMongoServiceImpl() {
